                            ...
                            <ul>
                                <li>
                                    ...
                                    <div className="text-box">
                                        ...
                                        <h2><Link href="tel:123456789">+968-96154505</Link></h2>
                                        <h2><Link href="tel:123456789">+968-98133589</Link></h2>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div className="text-box">
                                        <p>Oman Office</p>
                                        <h2>311, Suhar, Falaj Al Qabail,  <br /> Sultanate Of Oman</h2>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div className="text-box">
                                        <p>Email Us</p>
                                        <h2><Link href="mailto:yourmail@email.com">malqudratrading@gmail.com</Link></h2>
                                    </div>
                                </li>
